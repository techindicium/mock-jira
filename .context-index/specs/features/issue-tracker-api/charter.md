...
|-----------|-------------|----------|-------|--------|
| Create/list/get Project | Create a Project, list all Projects, fetch one by id | must-have | mvp | — |
...
| OpenAPI contract | Auto-generated, browsable API documentation | should-have | mvp | — |
